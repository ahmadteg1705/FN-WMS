...
@section('page-title', 'Master Tim Teknisi')
...
<div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
    <div>
        ...
        <p class="text-gray-500">
            Kelola daftar Tim Teknisi Fahasa Net
        </p>
    </div>
        ...
        <table class="w-full text-left border-collapse">
            <thead>
                <tr class="bg-gray-100 border-b border-gray-200 text-gray-700 text-xs uppercase tracking-wider font-semibold">
                    ...
                    <th class="py-4 px-6">Leader</th>
                    <th class="py-4 px-6 text-center">Jumlah Teknisi</th>
                ...
                <tr class="hover:bg-gray-50 transition">
                    ...
                    <td class="py-4 px-6 text-center">
                        <span class="inline-flex items-center px-2.5 py-1 rounded-md text-xs font-medium bg-blue-50 text-blue-700 border border-blue-200">
                            {{ $team->technicians()->count() }} Teknisi
                        </span>
                    </td>
                ...
                <tr>
                    <td colspan="6" class="text-center py-12 text-gray-500">
                        <div class="flex flex-col items-center justify-center gap-2">
                            <p class="text-base font-medium text-gray-600">Belum ada data Tim Teknisi.</p>
                            <p class="text-xs text-gray-400">Klik tombol "+ Tambah Tim" di atas untuk menambahkan data baru.</p>
                        </div>
                    </td>
                </tr>
                @endforelse
