...
<div class="flex justify-between items-center mb-6">
    <div>
        ...
        <p class="text-gray-500">
            Tambahkan data Teknisi Fahasa Net baru
        </p>
    </div>
    ...
    <form action="{{ route('technicians.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div>
                ...
                <select
                    name="user_id"
                    class="w-full border @error('user_id') border-red-500 @else border-gray-300 @enderror rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div class="md:col-span-2">
                ...
                <textarea
                    ...
                    class="w-full border @error('alamat') border-red-500 @else border-gray-300 @enderror rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('alamat') }}</textarea>
                @error('alamat')
                    <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
