...
<div class="w-full">
    <div class="mb-6 flex items-center justify-between">
        <div>
            ...
            <p class="text-sm text-slate-500">Perbarui informasi data jabatan.</p>
        </div>
    ...
    <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        <form action="{{ route('positions.update', $position) }}" method="POST" class="space-y-5">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                >{{ old('keterangan', $position->keterangan) }}</textarea>
            </div>
